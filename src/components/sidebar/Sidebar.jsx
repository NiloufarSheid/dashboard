...
<Typography variant='h6' ml={4} sx={{color:"#44444F", fontSize:"20px", fontWeight:"600"}}>
    Square
</Typography>
</div>
      <Divider  />
      ...
      <List>
        {['Dashboard', 'My site', 'Plan', 'Audience', "Plugin", "Widgets"].map((text, index) => (
